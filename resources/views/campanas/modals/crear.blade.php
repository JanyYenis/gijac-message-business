                ...
                <div class="modal-header">
                    <div class="">
                        <h1 class="modal-title text-white mulish">
                            <i class="bi bi-megaphone-fill fs-2 me-2 text-white"></i>{{ __('Crear Nueva Campaña') }}</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="step-content active" id="step-1">
                                    <div class="card campaign-card">
                                        ...
                                        <div class="card-body p-4">
                                            <div class="row g-3">
                                                <div class="col-md-8">
                                                    <label for="campaignName" class="form-label required fw-semibold">{{ __('Nombre de la Campaña') }}</label>
                                        ...
                                        <div class="card-body p-4">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6 d-none" id="scheduledFields">
                                                    ...
                                                    <input type="date" placeholder="{{ __('DD/MM/AAA') }}" name="fecha" class="form-control" id="scheduleDate">
                                                </div>
                                                <div class="col-md-6 d-none" id="scheduledTimeField">
                                                    <label for="scheduleTime"
                                                        class="form-label fw-semibold">{{ __('Hora') }}</label>
                                                    <input type="time" placeholder="{{ __('00:00') }}" name="hora" class="form-control" id="scheduleTime">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card campaign-card">
                                        ...
                                        <div class="card-body p-4">
                                            <div class="row g-3">
                                                    ...
                                                    <div class="row mb-3 d-none" id="divInputFile">
                                                        ...
                                                        <div class="col-lg-4 col-md-4">
                                                            <div class="form-check form-switch form-check-custom form-check-solid">
                                                                ...
                                                                <label class="form-check-label" for="checkUsarRecurso">{{ __('Usar recurso de META') }}</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                {{-- <div class="col-12">
                                                    <label class="form-label fw-semibold">{{ __('Variables Dinámicas') }}</label>
                                                    <div class="d-flex flex-wrap gap-2 mb-3">
                                                        <span class="variable-tag"
                                                            onclick="">{{ __('{nombre}') }}</span>
                                                        <span class="variable-tag"
                                                            onclick="">{{ __('{apellido}') }}</span>
                                                        <span class="variable-tag"
                                                            onclick="">{{ __('{empresa}') }}</span>
                                                        <span class="variable-tag"
                                                            onclick="">{{ __('{teléfono}') }}</span>
                                                        <span class="variable-tag"
                                                            onclick="">{{ __('{email}') }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label fw-semibold" for="attachFile">
                                                            <i class="bi bi-paperclip me-2"></i>{{ __('Adjuntar Archivo') }}</label>
                                                    </div>
                                                    <div id="fileUpload" style="display: none;" class="mt-3">
                                                        <input type="file" class="form-control"
                                                            accept="image/*,.pdf,.doc,.docx">
                                                        <div class="form-text">{{ __('Formatos permitidos: JPG, PNG, PDF, DOC,
                                                            DOCX (máx. 16MB)') }</div>
                                                    </div>
                                                </div> --}}
                                            </div>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    ...
                                    <div class="ms-auto">
                                        <button type="button" class="btn btn-primary-custom text-white" id="nextBtn">{{ __('Siguiente') }}<i class="bi bi-arrow-right ms-2"></i>
                                        </button>
                                        <button type="submit" class="btn btn-secondary-custom" id="launchBtn"
                                             style="display: none;">
                                            <i class="bi bi-rocket-takeoff-fill me-2"></i>{{ __('Lanzar Campaña') }}</button>
                                    </div>
                                </div>
                            </div>
