...
@section('content')
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6 text-white">
                    <span class="eyebrow"
                        ...
                        <i class="fa-solid fa-graduation-cap"></i> {{ __('Centro de Recursos') }}
                    </span>
                    <h1 class="mt-3">{{ __('Aprende a dominar') }} <span class="gradient-text">{{ __('GIJAC MESSAGE BUSINESS') }}</span></h1>
                    <p class="lead">{{ __('Documentación, cursos, videotutoriales, guías rápidas y plantillas listas para usar. Todo lo que necesitas para llevar tu comunicación por WhatsApp al siguiente nivel.') }}</p>
                        ...
                        <div class="deck" id="heroDeck">
                            <div class="panel-3d panel-main" style="width:340px">
                                ...
                                <div class="mini-metric">
                                    ...
                                    <div><b>4.9</b><span>{{ __('Valoración') }}</span></div>
                                    <div><b>32m</b><span>{{ __('Restante') }}</span></div>
                                </div>
                            </div>
    ...
    <section class="section videos" id="videos">
        <div class="container">
            ...
            <p class="section-sub">{{ __('Tutoriales cortos y directos para resolver tareas concretas dentro de la plataforma.') }}
            </p>
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 reveal">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-5">
                    ...
                    <p class="section-sub">{{ __('Las respuestas que más consulta nuestra comunidad. ¿No encuentras la tuya? Escríbenos desde el centro de soporte.') }}</p>
                    ...
                    <div class="accordion" id="faqAcc">
                        <div class="accordion-item">
                            ...
                            <div id="f1" class="accordion-collapse collapse show" data-bs-parent="#faqAcc">
                                <div class="accordion-body">{{ __('Desde') }} <b>{{ __('Administración → Canales') }}</b> {{ __('selecciona “Conectar WhatsApp”, verifica tu número de empresa y completa la validación de Meta. El proceso suele tardar entre 5 y 20 minutos.') }}</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header"><button class="accordion-button collapsed"
                                    data-bs-toggle="collapse" data-bs-target="#f2">{{ __('¿Por qué mi plantilla fue rechazada?') }}</button></h2>
                            <div id="f2" class="accordion-collapse collapse" data-bs-parent="#faqAcc">
                                <div class="accordion-body">{{ __('Las causas más comunes son categorías incorrectas, variables sin ejemplo o contenido promocional en plantillas de servicio. Revisa la guía “Evita el rechazo de plantillas”.') }}</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header"><button class="accordion-button collapsed"
                                    data-bs-toggle="collapse" data-bs-target="#f3">{{ __('¿Cuántos contactos puedo importar?') }}</button></h2>
                            <div id="f3" class="accordion-collapse collapse" data-bs-parent="#faqAcc">
                                <div class="accordion-body">{{ __('Depende de tu plan. En todos los planes puedes importar por lotes de hasta 50.000 registros por archivo CSV, con deduplicación automática por número.') }}</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header"><button class="accordion-button collapsed"
                                    data-bs-toggle="collapse" data-bs-target="#f4">{{ __('¿El asistente IA responde solo?') }}</button></h2>
                            <div id="f4" class="accordion-collapse collapse" data-bs-parent="#faqAcc">
                                <div class="accordion-body">{{ __('Sí, dentro de los límites que definas. Puedes configurar tono, temas permitidos y una regla de transferencia a un agente humano cuando no logre resolver la conversación.') }}</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header"><button class="accordion-button collapsed"
                            ...
                            <div id="f5" class="accordion-collapse collapse" data-bs-parent="#faqAcc">
                                <div class="accordion-body">{{ __('Sí. Usa webhooks entrantes y salientes o conecta n8n para sincronizar contactos, etiquetas y eventos de conversación en tiempo real.') }}</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header"><button class="accordion-button collapsed"
                                    data-bs-toggle="collapse" data-bs-target="#f6">{{ __('¿Los cursos entregan certificado?') }}</button></h2>
                            <div id="f6" class="accordion-collapse collapse" data-bs-parent="#faqAcc">
                                <div class="accordion-body">{{ __('Al completar el 100% de las lecciones y aprobar la evaluación final recibirás un certificado digital verificable con tu nombre y la fecha de finalización.') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 reveal">
                    <div class="news-card tilt"><span class="bar"></span>
                        ...
                        <p class="text-secondary mb-3">{{ __('Programa y arrastra tus campañas en vistas de mes, semana y día.') }}
                        </p>
                ...
                <div class="col-md-6 col-lg-4 reveal" data-delay="80">
                    <div class="news-card tilt"><span class="bar"></span>
                        ...
                        <p class="text-secondary mb-3">{{ __('Nueva base de conocimiento con búsqueda semántica y citas de origen.') }}</p>
                ...
                <div class="col-md-6 col-lg-4 reveal" data-delay="160">
                    <div class="news-card tilt"><span class="bar"></span>
                        ...
                        <p class="text-secondary mb-3">{{ __('Diseña la atención con nodos arrastrables e integraciones de IA.') }}
                        </p>
            ...
            <div class="support">
                <div class="row align-items-center g-4">
                    <div class="col-lg-7">
                        ...
                        <p>{{ __('Nuestro equipo responde en menos de 2 horas hábiles. Chatea con nosotros, abre un ticket o agenda una sesión guiada con un especialista GIJAC.') }}</p>
                        <div class="d-flex flex-wrap gap-2 mt-4">
                            <a type="button" href="https://wa.me/573171789584" class="btn-gj" data-toast="Abriendo chat con soporte">
                                <i class="fa-brands fa-whatsapp me-2"></i>
                                {{ __('Chatear por WhatsApp') }}
                            </a>
