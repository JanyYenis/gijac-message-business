...
@section('content')
    <div class="page-header">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
            <div>
                <h1 class="text-white">
                    <i class="fab fa-whatsapp"></i>{{ __('Dashboard Analytics') }}</h1>
...
<div class="container-fluid main-container">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card metric-card">
                    ...
                    {{-- <div class="metric-change positive">
                        ...
                        <span>{{ __('+12.5% vs mes anterior') }}</span>
                    </div> --}}
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="card metric-card">
                    ...
                    {{-- <div class="metric-change positive">
                        <i class="fas fa-arrow-up"></i>
                        <span>{{ __('+8.3% vs mes anterior') }}</span>
                    </div> --}}
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="card metric-card">
                    ...
                    <h3 class="metric-value fs-2" id="diaEfectivo">{{ __('N/A') }}</h3>
                    <p class="metric-label">{{ __('Tu día más efectivo') }}</p>
                    {{-- <div class="metric-change negative">
                        <i class="fas fa-arrow-down"></i>
                        <span>{{ __('-3.2% vs mes anterior') }}</span>
                    </div> --}}
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="card metric-card">
                    ...
                    {{-- <div class="metric-change positive">
                        <i class="fas fa-arrow-up"></i>
                        <span>{{ __('+2.1% vs mes anterior') }}</span>
                    </div> --}}
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-lg-8">
                <div class="card chart-card">
                    <h5 class="chart-title">
                        <i class="fas fa-chart-bar text-primary"></i>{{ __('Campañas Enviadas por Mes') }}</h5>
            ...
            <div class="col-lg-4">
                <div class="card chart-card">
                    <h5 class="chart-title">
                        <i class="fas fa-chart-pie text-success"></i>{{ __('Distribución por Etiquetas') }}</h5>
                    <div class="chart-container">
        ...
        <div class="row g-4 mb-4">
            <div class="col-lg-6">
                <div class="card chart-card">
                    <h5 class="chart-title">
                        <i class="fas fa-clock text-warning"></i>{{ __('Horarios de Apertura por Día') }}</h5>
            ...
            <div class="col-lg-6">
                <div class="card chart-card">
                    <h5 class="chart-title">
                        <i class="fas fa-exchange-alt text-info"></i>{{ __('Embudo de efectividad') }}</h5>
                    <div class="chart-container">
        ...
        {{-- <div class="card table-card">
            <h5 class="chart-title">
                <i class="fas fa-history text-secondary"></i>{{ __('Campañas') }}</h5>
            <div class="table-responsive">
                <table class="table" id="tablaCampanas">
                    <thead>
                        <tr>
                            <th>{{ __('Nombre de Campaña') }}</th>
                            <th>{{ __('Estado') }}</th>
                            <th>{{ __('Fecha de Envío') }}</th>
                            <th>{{ __('Mensajes Enviados') }}</th>
                            <th>{{ __('Efectividad') }}</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>
                                <div class="fw-semibold">{{ __('Black Friday 2024') }}</div>
                                <small class="text-muted">{{ __('Promoción especial') }}</small>
                            </td>
                            <td><span class="status-badge status-active">{{ __('Activo') }}</span></td>
                            <td>{{ __('15 Nov 2024') }}</td>
                            <td>{{ __('8,547') }}</td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="fw-semibold">{{ __('Recordatorio de Pago') }}</div>
                                <small class="text-muted">{{ __('Notificación automática') }}</small>
                            </td>
                            <td><span class="status-badge status-finished">{{ __('Finalizado') }}</span></td>
                            <td>{{ __('12 Nov 2024') }}</td>
                            <td>{{ __('3,421') }}</td>
                            <td>
                                <div class="d-flex align-items-center">
                        ...
                        <tr>
                            <td>
                                <div class="fw-semibold">{{ __('Bienvenida Nuevos Clientes') }}</div>
                                <small class="text-muted">{{ __('Mensaje de bienvenida') }}</small>
                            </td>
                            <td><span class="status-badge status-paused">{{ __('Pausado') }}</span></td>
                            <td>{{ __('10 Nov 2024') }}</td>
                            <td>{{ __('1,234') }}</td>
                            <td>
                                <div class="d-flex align-items-center">
                        ...
                        <tr>
                            <td>
                                <div class="fw-semibold">{{ __('Encuesta de Satisfacción') }}</div>
                                <small class="text-muted">{{ __('Feedback de clientes') }}</small>
                            </td>
                            <td><span class="status-badge status-finished">{{ __('Finalizado') }}</span></td>
                            <td>{{ __('08 Nov 2024') }}</td>
                            <td>{{ __('5,678') }}</td>
                            <td>
                                <div class="d-flex align-items-center">
                        ...
                        <tr>
                            <td>
                                <div class="fw-semibold">{{ __('Oferta Cyber Monday') }}</div>
                                <small class="text-muted">{{ __('Descuentos especiales') }}</small>
                            </td>
                            <td><span class="status-badge status-active">{{ __('Activo') }}</span></td>
                            <td>{{ __('05 Nov 2024') }}</td>
                            <td>{{ __('12,890') }}</td>
                            <td>
                                <div class="d-flex align-items-center">
