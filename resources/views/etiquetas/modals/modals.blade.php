<div class="modal fade" tabindex="-1" id="modalEditarEtiqueta">
    <form id="formEditarEtiqueta" enctype="multipart/form-data">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title text-white mulish">{{ __('Editar Etiqueta') }}</h1>
