    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-white" style="font-size: 30px;">{{ __('Cargar contactos de campaña') }}</h5>
                <!--begin::Close-->
            ...
            <div class="modal-body">
                ...
                <div id="alertaError" class="alert alert-dismissible bg-light-danger border border-danger border-dotted d-flex flex-column flex-sm-row p-5 mb-10 d-none">
                    ...
                    <div class="d-flex flex-column pe-0 pe-sm-10">
                        <h5 class="mb-1">{{ __('Información importante.') }}</h5>
                        <span>{{ __('Los siguientes campos son requeridos para enviar la campaña.') }}</span>
                        <div class="container">
                ...
                <div class="alert alert-dismissible bg-light-primary border border-primary d-flex flex-column flex-sm-row p-5 mb-10">
                    ...
                    <div class="d-flex flex-column pe-0 pe-sm-10">
                        <h5 class="mb-1">{{ __('Información importante') }}</h5>
                        <span>{{ __('Por favor, no cambie el orden de los campos que a cargar. Si desea tener un ejemplo de la estructura de los archivos, puede descargarlos dando clic en el botón de Excel que aparece a continuación:') }}</span>
                        <div class="container py-4">
                            ...
                            <a href="{{ asset('estructuras/estructura-campañas.xlsx') }}" class="btn btn-success hover-scale">
                                <i class="fas fa-file-excel"></i>{{ __('Excel') }}</a>
                        </div>
                    </div>
                    <button type="button" class="position-absolute position-sm-relative m-2 m-sm-0 top-0 end-0 btn btn-icon ms-sm-auto" data-bs-dismiss="alert">
                ...
                <!--end::Alert-->
                <div class="row mb-7">
                    <select name="marca" id="selectMarca1" class="form-control" data-control="select2" data-placeholder="{{ __('Marca') }}" data-allow-clear="true" required data-dropdown-parent="body">
                        <option></option>
                ...
                <div class="row mb-7">
                    <select name="material" id="selectMaterial" class="form-control" data-control="select2" data-placeholder="{{ __('Material') }}" data-allow-clear="true"data-hide-search="true" required>
                        <option></option>
                        <option value="{{ __('Info') }}">{{ __('Información') }}</option>
                        <option value="{{ __('Invi') }}">{{ __('Invitación') }}</option>
                        <option value="{{ __('Podcast') }}">{{ __('Podcast') }}</option>
                    </select>
                </div>
                <div class="row mb-7">
                ...
                <div class="form-check py-3">
                    ...
                    <label class="form-label" for="tiene_encabezado">{{ __('Eliminar encabezado') }}</label>
                </div>
                <form id="kt_dropzonejs_example_1" enctype="multipart/form-data" class="dropzone">
                    <div class="fv-row">
                        <div class="dz-message needsclick">
                            ...
                            <div class="ms-4">
                                <h3 class="fs-5 fw-bold text-gray-900 mb-1">{{ __('Cargar Archivo Excel') }}</h3>
                                <span class="fs-7 fw-semibold text-gray-400">{{ __('Maximo 1 Archivos') }}</span>
                            </div>
                        </div><br>
                    </div>
                </form>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btnG btnG-primary obalado guardar" id="enviarButton">{{ __('Cargar') }}</button>
            </div>
        </div>
    </div>
</div> --}}
