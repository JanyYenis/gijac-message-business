        ...
        <div class="modal-content" style="border-radius:16px;border:none;">
            <div class="modal-header border-0">
                <h5 class="modal-title text-white">
                    <i class="fa-solid fa-paper-plane me-2 text-white fs-1"></i>{{ __('Probar Webhook') }}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label class="form-label">{{ __('Mensaje') }}</label>
                    <input type="text" class="form-control" id="tMsg" value="{{ __('Hola') }}">
                </div>
                <button class="btn btn-wa w-100 mb-3" id="btnEnviarPrueba">
                    <i class="bi bi-send me-1"></i>{{ __('Enviar Prueba') }}</button>
                <div id="testOut" style="display:none">
                    <label class="form-label">{{ __('Request enviado') }}</label>
                    <div class="req-box mb-2" id="reqBox"></div>
                    <label class="form-label">{{ __('Response recibida') }}</label>
