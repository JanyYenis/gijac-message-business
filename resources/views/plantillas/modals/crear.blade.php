                    ...
                    <div class="modal-grid">
                        ...
                        <div class="modal-col-config">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" id="tplCategory" name="category" data-control="select2"
                                            ...
                                            data-hide-search="true" data-dropdown-parent="#modalCrearPlantilla">
                                            <option value=""></option>
                                            @foreach ($categorias as $categoria)
                                                <option value="{{ $categoria->codigo }}">{{ __($categoria->nombre) }}</option>
                                            @endforeach
                                        </select>
                                        <div class="field-error"></div>
                                    </div>
                            ...
                            <section class="sec-card">
                                ...
                                <div id="bodyFreePane">
                                    <p class="sec-hint">
                                        {{ __('El texto principal que recibirá tu cliente. Usa variables numeradas como') }} @{{ 1 }}, @{{ 2 }}…
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <div class="sec-title mb-0">
                                            ...
                                            {{ __('Pie de página') }}
                                            <span class="sec-optional" id="footerOptionalLabel">{{ __('Opcional') }}</span>
                                        </div>
                            ...
                            <section class="sec-card">
                                ...
                                <div id="authButtonNotice" class="help-text d-none mb-2">
                                    <i class="fa-solid fa-lock me-1"></i>
                                    {{ __('Las plantillas de Autenticación solo admiten') }} <b>{{ __('un') }}</b> {{ __('botón de tipo OTP.') }}
                                </div>
