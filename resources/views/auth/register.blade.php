        ...
        <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework"
            ...
            <div class="fv-row mb-8 fv-plugins-icon-container">
                <label class="form-check form-check-inline">
                    <span class="form-check-label fw-semibold text-muted fs-base ms-1">{{ __('Al continuar, Acepto los') }}<a href="{{ route('terminos-condiciones') }}" target="_blank" class="ms-1 link">{{ __('Terminos y condiciones') }}</a>{{ __('y las') }}<a href="{{ route('politicas-privacidad') }}" target="_blank" class="ms-1 link">{{ __('politicas de privacidad') }}</a>
                    </span>
                </label>
            ...
            <button class="btn-primary-x magnetic" id="kt_sign_up_submit" type="submit">
                ...
                <span class="indicator-label">{{ __('Iniciar prueba de 15 días.') }}</span>
                <!--end::Indicator label-->
            </button>
