        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
                    ...
                    <div class="ms-3">
                        <h1 class="text-white">
                            ...
                            {{ __('Automatizaciones con n8n') }}
                        </h1>
                        <p class="subtitle mb-0">
                            {{ __('Conecta tu instancia de n8n para crear flujos avanzados, integrar sistemas externos y automatizar procesos empresariales.') }}
                        </p>
                    </div>
                </div>
            </div>
            <div class="mt-3 mt-md-0">
                <span class="badge-status me-2">
                    ...
                    @endif
                    {{ $automatizacion?->webhook_activo ? __('Conectado') : __('Desconectado') }}
                </span>
            ...
            <form id="formN8n">
                ...
                <div class="card-mod mb-4">
                    <div class="card-header fs-1">
                        ...
                        {{ __('Datos Enviados a n8n') }}
                    </div>
                    <div class="card-body">
                        <p class="text-muted fs-6 small mb-2">
                            {{ __('Estos son los datos que GIJAC MESSAGE BUSINESS enviará en cada evento:') }}
                        </p>
                        <div class="json-viewer" id="jsonExample">
                            ...
                            <span class="k">{{ __('"event"') }}</span>
                            <span class="p">:</span>
                            <span class="s">{{ __('"message.received"') }}</span>
                            <span class="p">,</span><br>&nbsp;
                            <span class="k">{{ __('"automation_id"') }}</span>
                            <span class="p">:</span>
                            <span class="s">{{ __('"GmB-123..."') }}</span>
                            <span class="p">,</span><br>&nbsp;
                            <span class="k">{{ __('"company_id"') }}</span>
                            <span class="p">:</span>
                            <span class="s">{{ __('"GmB-123..."') }}</span>
                            <span class="p">,</span><br>&nbsp;
                            <span class="k">{{ __('"contact"') }}</span>
                            <span class="p">:</span>
                            <span class="p">{</span><br>&nbsp;&nbsp;&nbsp;&nbsp;
                            <span class="k">{{ __('"id"') }}</span>
                            <span class="p">:</span>
                            <span class="s">{{ __('"GmB-123..."') }}</span>
                            <span class="p">,</span><br>&nbsp;&nbsp;&nbsp;&nbsp;
                            <span class="k">{{ __('"name"') }}</span>
                            <span class="p">:</span>
                            <span class="s">{{ __('"Juan Pérez"') }}</span>
                            <span class="p">,</span><br>&nbsp;&nbsp;&nbsp;&nbsp;
                            <span class="k">{{ __('"phone"') }}</span>
                            <span class="p">:</span>
                            <span class="s">"573001234567"</span><br>&nbsp;
                            <span class="p">}</span>
                            <span class="p">,</span><br>&nbsp;
                            <span class="k">{{ __('"message"') }}</span>
                            <span class="p">:</span>
                            <span class="p">{</span><br>&nbsp;&nbsp;&nbsp;&nbsp;
                            <span class="k">{{ __('"id"') }}</span>
                            <span class="p">:</span>
                            ...
                            <span class="p">,</span><br>&nbsp;&nbsp;&nbsp;&nbsp;
                            <span class="k">{{ __('"phone_number_id"') }}</span>
                            <span class="p">:</span>
            ...
            <div class="card-mod mb-4">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-wa-outline w-100 mb-3" data-bs-toggle="modal" data-bs-target="#modalProbar">
                        ...
                        {{ __('Enviar Prueba Personalizada') }}
                    </button>
                    <div class="test-result test-ok" id="resOk">
                        ...
                        <span class="d-block fw-normal small mt-1">
                            {{ __('Respuesta 200 OK · 312 ms') }}
                        </span>
                    </div>
                    <div class="test-result test-err" id="resErr">
                        <i class="bi bi-x-circle-fill text-danger me-1"></i>
                        {{ __('Error de Conexión') }}
                        <span class="d-block fw-normal small mt-1">
                            {{ __('Tiempo de espera agotado.') }}
                        </span>
                    </div>
                </div>
            </div>
