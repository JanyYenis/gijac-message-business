        ...
        <div class="modal-content" style="border-radius:14px; overflow:hidden;">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="bi bi-play-circle me-1 text-white"></i>{{ __('Probar Flujo — Simulador') }}</h5>
            ...
            <div class="modal-body p-0">
                <div class="sim-grid">
                    ...
                    <div class="sim-left">
                        <h6 class="fw-bold mb-2 fs-4">{{ __('Flujo') }}</h6>
                    ...
                    <div class="wa-chat">
                        <div class="wa-chat-head">
                            ...
                            <div>
                                <div style="font-weight:600; font-size:0.9rem;">{{ __('Chatbot GIJAC') }}</div>
                                <div style="font-size:0.72rem; opacity:.85;">{{ __('en línea') }}</div>
                            </div>
                        </div>
                        <div class="wa-chat-body" id="simChat">
                            <div class="wa-msg bot">{{ __('¡Hola! Bienvenido a GIJAC MESSAGE BUSINESS. ¿En qué podemos ayudarte hoy?') }}</div>
                            <div class="wa-msg bot">{{ __('Por favor acepta nuestros términos para continuar:') }}</div>
                        </div>
