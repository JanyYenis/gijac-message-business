            ...
            <div class="modal-body">
                ...
                <div class="alert alert-info-custom alert-dismissible fade show" role="alert" id="infoAlert">
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            <strong>{{ __('Información importante:') }}</strong> {{ __('Por favor, no cambie el orden de los campos que va a cargar. Si desea tener un ejemplo de la estructura de los archivos, puede descargarlos dando clic en el botón de Excel que aparece a continuación.') }}
                        </div>
                    </div>
