            ...
            <div class="row">
                ...
                <div class="col-lg-7 mb-5">
                    <div class="card">
                        <div class="card-header" style="background-color: var(--primary-color); color: white;">
                            <h3 class="mb-0">
                                <i class="fas fa-envelope me-2"></i>{{ __('Envíanos un Mensaje') }}
                            </h3>
                        </div>
                        <div class="card-body">
                            <form id="contactForm">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label for="firstName" class="form-label required">
                                            <i class="fas fa-user me-2"></i>{{ __('Nombre') }}
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="lastName" class="form-label required">
                                            <i class="fas fa-user me-2"></i>{{ __('Apellidos') }}
                                        </label>
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-md-6">
                                        <label for="phone" class="form-label">
                                            <i class="fas fa-phone me-2"></i>{{ __('Teléfono') }}
                                        </label>
                                ...
                                <div class="mb-3 mt-3">
                                    <label for="company" class="form-label">
                                        <i class="fas fa-building me-2"></i>{{ __('Empresa') }}
                                    </label>
                                ...
                                <div class="mb-3">
                                    <label for="subject" class="form-label required">
                                        <i class="fas fa-tag me-2"></i>{{ __('Asunto') }}
                                    </label>
                                    <select class="form-select" id="subject" name="asunto" required>
                                        <option value="">{{ __('Selecciona un tema') }}</option>
                                        <option value="pricing">{{ __('Consulta sobre Precios') }}</option>
                                        <option value="demo">{{ __('Solicitud de Demo') }}</option>
                                        <option value="technical">{{ __('Soporte Técnico') }}</option>
                                        <option value="integration">{{ __('Integración/API') }}</option>
                                        <option value="sales">{{ __('Ventas - Plan Enterprise') }}</option>
                                        <option value="billing">{{ __('Facturación') }}</option>
                                ...
                                <div class="mb-3">
                                    <label for="message" class="form-label required">
                                        <i class="fas fa-comment-dots me-2"></i>{{ __('Mensaje') }}
                                    </label>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label required" for="privacy">
                                            {{ __('Acepto las') }} <a href="{{ route('politicas-privacidad') }}" target="_blank">{{ __('Políticas de Privacidad') }}</a>
                                            {{ __('y el tratamiento de mis datos') }}
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="newsletter">
                                            {{ __('Quiero recibir noticias y actualizaciones sobre la plataforma') }}
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-primary btn-lg">
                                        <i class="fas fa-paper-plane me-2"></i>{{ __('Enviar Mensaje') }}
                                    </button>
                                </div>
                            </form>
                        </div>
                ...
                <div class="col-lg-5">
                            ...
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <a href="https://wa.me/573171789584" target="_blank" class="btn btn-success">
                                        <i class="fab fa-whatsapp me-2"></i>{{ __('Abrir Chat') }}
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card" style="height: auto !important;">
                        <div class="card-header" style="background-color: var(--primary-color); color: white;">
                            <h5 class="mb-0">
                                <i class="fas fa-map-marker-alt me-2"></i>{{ __('Nuestra Oficina') }}
                            </h5>
                        </div>
                        <div class="card-body">
                            <address class="mb-3">
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    ...
                                    <strong>{{ __('Lunes a Viernes:') }}</strong> {{ __('9:00 AM - 5:00 PM (EST)') }}
                                </li>
                                <li>
                                    <i class="fas fa-times me-2"></i>
                                    <strong>{{ __('Sábados y Domingos:') }}</strong> {{ __('Cerrado') }}
                                </li>
                            </ul>

                            <div class="alert alert-info">
                                <i class="fas fa-headset me-2"></i>
                                <strong>{{ __('Soporte 24/7:') }}</strong> {{ __('Usuarios Enterprise tienen acceso a soporte técnico las 24 horas.') }}
                            </div>
                        </div>
                    </div>
                </div>
