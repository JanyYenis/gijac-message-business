                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="mb-5">
                        <h2 class="section-title text-start">
                            <i class="fas fa-info-circle me-2"></i>{{ __('Preguntas Generales') }}
                        </h2>
                            ...
                            <div class="accordion-item">
                                <h3 class="accordion-header" id="general1">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        {{ __('¿Cómo funciona la plataforma?') }}
                                    </button>
                                </h3>
                                <div id="generalAnswer1" class="accordion-collapse collapse show"
                                    data-bs-parent="#generalAccordion">
                                    <div class="accordion-body">
                                        <p>{{ __('Nuestra plataforma se conecta directamente a la API oficial de WhatsApp Business, permitiéndote:') }}</p>
                                        <ul class="mb-3">
                                            <li><strong>{{ __('Enviar mensajes masivos:') }}</strong> {{ __('Crea campañas personalizadas para miles de contactos') }}</li>
                                            <li><strong>{{ __('Automatizar respuestas:') }}</strong> {{ __('Configura respuestas automáticas para consultas frecuentes') }}</li>
                                            <li><strong>{{ __('Gestionar conversaciones:') }}</strong> {{ __('Centraliza todos los chats en una sola interfaz') }}</li>
                                            <li><strong>{{ __('Analizar resultados:') }}</strong> {{ __('Obtén métricas detalladas de entrega y engagement') }}</li>
                                        </ul>
                                        <p>{{ __('El proceso es simple: conectas tu cuenta de WhatsApp Business, importas tus contactos, creas tus campañas y la plataforma se encarga del resto.') }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h3 class="accordion-header" id="general2">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        {{ __('¿Es seguro usar la plataforma?') }}
                                    </button>
                                </h3>
                                <div id="generalAnswer2" class="accordion-collapse collapse"
                                    data-bs-parent="#generalAccordion">
                                    <div class="accordion-body">
                                        <p><strong>{{ __('Absolutamente seguro.') }}</strong> {{ __('Implementamos las mejores prácticas de seguridad:') }}</p>
                                        <ul class="mb-3">
                                        ...
                                        <p>{{ __('Además, utilizamos la API oficial de WhatsApp Business, por lo que tu cuenta siempre cumple con los términos y condiciones de WhatsApp.') }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="generalAnswer3" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <p>{{ __('Nosotros te ayudamos con todo el proceso de configuración y conexión a la API de WhatsApp Business.') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-5">
                        <h2 class="section-title text-start">
                            <i class="fas fa-bullhorn me-2"></i>{{ __('Campañas y Envíos') }}
                        </h2>
                            ...
                            <div class="accordion-item">
                                <h3 class="accordion-header" id="campaigns1">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        {{ __('¿Puedo enviar campañas por etiquetas?') }}
                                    </button>
                                </h3>
                                <div id="campaignsAnswer1" class="accordion-collapse collapse"
                                    data-bs-parent="#campaignsAccordion">
                                    <div class="accordion-body">
                                        <p><strong>{{ __('¡Por supuesto!') }}</strong> {{ __('Nuestro sistema de etiquetas te permite segmentar tu audiencia de forma muy precisa:') }}</p>
                                        <ul class="mb-3">
                                            <li><strong>{{ __('Etiquetas automáticas:') }}</strong> {{ __('Basadas en comportamiento, ubicación, fecha de registro') }}</li>
                                            <li><strong>{{ __('Etiquetas manuales:') }}</strong> {{ __('Que puedes asignar según tus criterios comerciales') }}</li>
                                            <li><strong>{{ __('Combinación de etiquetas:') }}</strong> {{ __('Crea segmentos súper específicos combinando múltiples etiquetas') }}</li>
                                            <li><strong>{{ __('Etiquetas dinámicas:') }}</strong> {{ __('Que se actualizan automáticamente según nuevas interacciones') }}</li>
                                        </ul>
                                        <p>{{ __('Por ejemplo: puedes enviar una campaña solo a "Clientes VIP + Madrid + Compra reciente" para máxima personalización.') }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h3 class="accordion-header" id="campaigns2">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        {{ __('¿Puedo programar campañas?') }}
                                    </button>
                                </h3>
                                <div id="campaignsAnswer2" class="accordion-collapse collapse"
                                    data-bs-parent="#campaignsAccordion">
                                    <div class="accordion-body">
                                        <p><strong>{{ __('Sí, completamente.') }}</strong> {{ __('Nuestra funcionalidad de programación incluye:') }}</p>
                                        <div class="row g-3 mb-3">
                                            <div class="col-md-4">
                                        ...
                                        <p>{{ __('Además, puedes programar secuencias de mensajes automáticas basadas en triggers específicos.') }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h3 class="accordion-header" id="campaigns3">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        {{ __('¿Qué tipos de mensajes puedo enviar?') }}
                                    </button>
                                </h3>
                                <div id="campaignsAnswer3" class="accordion-collapse collapse"
                                    data-bs-parent="#campaignsAccordion">
                                    <div class="accordion-body">
                                        <p>{{ __('Puedes enviar todos los tipos de mensajes soportados por WhatsApp Business API:') }}
                                        </p>
                                        <div class="row g-3 mb-3">
                                            <div class="col-md-6">
                                                <ul>
                                        ...
                                        <div class="alert alert-info">
                                            ...
                                            <strong>{{ __('Tip:') }}</strong> {{ __('Los mensajes con plantillas pre-aprobadas por WhatsApp tienen mayor tasa de entrega.') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mb-5">
                        <h2 class="section-title text-start">
                            <i class="fas fa-dollar-sign me-2"></i>{{ __('Precios y Facturación') }}
                        </h2>
                            ...
                            <div class="accordion-item">
                                <h3 class="accordion-header" id="pricing1">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        {{ __('¿Los precios incluyen el costo de WhatsApp Business?') }}
                                    </button>
                                </h3>
                                <div id="pricingAnswer1" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <div class="alert alert-warning mb-3">
                                            ...
                                            <strong>{{ __('No, los precios de la plataforma NO incluyen los costos de WhatsApp Business API.') }}</strong>
                                        </div>
                                        <p>{{ __('Nuestros precios cubren únicamente el uso de la plataforma. Los envíos se facturan por separado según las tarifas oficiales de') }}
                                            <a href="https://developers.facebook.com/docs/whatsapp/pricing/?translation"
                                                target="_blank" class="link-primary">{{ __('WhatsApp') }}
                                            </a>.
                                        </p>
                                        ...
                                        <p><small><em>{{ __('Los precios varían según el país de destino. Una conversación puede incluir múltiples mensajes en un período de 24 horas.') }}</em></small></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h3 class="accordion-header" id="pricing2">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        {{ __('¿Hay costos ocultos o adicionales?') }}
                                    </button>
                                </h3>
                                <div id="pricingAnswer2" class="accordion-collapse collapse"
                                    data-bs-parent="#pricingAccordion">
                                    <div class="accordion-body">
                                        <p><strong>{{ __('No hay costos ocultos.') }}</strong> {{ __('Nuestro modelo de precios es 100% transparente:') }}</p>
                                        <div class="row g-3 mb-3">
                                            <div class="col-md-6">
                            ...
                            <div class="accordion-item">
                                <h3 class="accordion-header" id="pricing3">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        {{ __('¿Puedo cambiar de plan en cualquier momento?') }}
                                    </button>
                                </h3>
                                <div id="pricingAnswer3" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <ul class="mb-3">
                                            ...
                                            <li><strong>{{ __('Sin penalizaciones:') }}</strong> {{ __('No cobramos fees por cambios de plan') }}
                                            </li>
                                            <li><strong>{{ __('Flexibilidad total:') }}</strong> {{ __('Adapta el plan al crecimiento de tu negocio') }}</li>
                                        </ul>
                                        <div class="alert alert-success">
                                            <i class="fas fa-gift me-2"></i>
                                            <strong>{{ __('Bonus:') }}</strong> {{ __('Si necesitas más recursos temporalmente (como en Black Friday), podemos activar un boost temporal sin cambiar tu plan base.') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mb-5">
                        <h2 class="section-title text-start">
                            <i class="fas fa-cogs me-2"></i>{{ __('Aspectos Técnicos') }}
                        </h2>
                            ...
                            <div class="accordion-item">
                                <h3 class="accordion-header" id="technical1">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        {{ __('¿Tienen API disponible para integraciones?') }}
                                    </button>
                                </h3>
                                <div id="technicalAnswer1" class="accordion-collapse collapse"
                                    data-bs-parent="#technicalAccordion">
                                    <div class="accordion-body">
                                        <p><strong>{{ __('Sí, tenemos una API RESTful completa') }}</strong> {{ __('disponible en los planes Professional y Enterprise:') }}</p>
                                        <div class="row g-3 mb-3">
                                            <div class="col-md-6">
                                        ...
                                        <div class="alert alert-info">
                                            ...
                                            <strong>{{ __('Para Desarrolladores:') }}</strong> {{ __('Nuestra API sigue estándares REST, usa autenticación JWT y soporta rate limiting para uso eficiente.') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h3 class="accordion-header" id="technical2">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        {{ __('¿Qué límites de envío tiene WhatsApp?') }}
                                    </button>
                                </h3>
                                <div id="technicalAnswer2" class="accordion-collapse collapse"
                                    data-bs-parent="#technicalAccordion">
                                    <div class="accordion-body">
                                        <p>{{ __('WhatsApp Business API tiene límites que van aumentando según tu reputación y volumen histórico:') }}</p>
                                        <table class="table table-striped mb-3">
                                            <thead>
                                                <tr>
                                        ...
                                        <div class="alert alert-warning">
                                            <i class="fas fa-lightbulb me-2"></i>
                                            <strong>{{ __('Importante:') }}</strong> {{ __('Una conversación puede incluir múltiples mensajes. Los límites se resetean cada 24 horas.') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <p class="lead mb-4">{{ __('Nuestro equipo de soporte está disponible para resolver cualquier duda que tengas.') }}
                    </p>
                    <div class="row justify-content-center g-3">
                        <div class="col-md-4">
                            <a href="{{ route('contactarnos') }}" class="btn btn-light btn-lg w-100">
                                <i class="fas fa-envelope me-2"></i>{{ __('Enviar Consulta') }}
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="tel:+573171789584" class="btn btn-outline-light btn-lg w-100">
                                <i class="fas fa-phone me-2"></i>{{ __('Llamar Ahora') }}
                            </a>
                        </div>
                        <div class="col-md-4">
