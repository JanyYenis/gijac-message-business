    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('Detalle de versión') }}<span id="mvvNumero"></span></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <p class="mb-2">
                    <strong>{{ __('Publicado:') }}</strong> <span id="mvvFecha"></span> —
                    <strong>{{ __('Usuario:') }}</strong> <span id="mvvUsuario"></span>
                </p>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-warning" id="btnRestaurarDesdeModal">
                    <i class="bi bi-arrow-counterclockwise"></i>{{ __('Restaurar esta versión') }}</button>
            </div>
        </div>
    </div>
</div>
