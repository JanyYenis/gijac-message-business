    ...
    <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <div class="fv-row mb-0 fv-plugins-icon-container">
                                ...
                                <input type="email" class="form-control" id="emailaddress" placeholder="{{ __('Correo electronico') }}"
                        ...
                        <div class="col-lg-6">
                            <div class="fv-row mb-0 fv-plugins-icon-container">
                                <label for="confirmemailpassword" class="form-label fs-6 fw-bold mb-3">{{ __('Confirmar contraseña') }}</label>
        ...
        <div class="d-flex flex-wrap align-items-center mb-10">
            ...
            <div id="kt_signin_password">
                <div class="fs-5 fw-bold mb-1 text-dark">{{ __('Contraseña') }}</div>
            ...
            <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                ...
                <form id="kt_signin_change_password" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    ...
                    <div class="row mb-1">
                        <div class="col-lg-4">
                            <div class="fv-row mb-0 fv-plugins-icon-container">
                                <label for="currentpassword" class="form-label fs-5 fw-bold mb-3">{{ __('Actual contraseña') }}</label>
                        ...
                        <div class="col-lg-4">
                            <div class="fv-row mb-0 fv-plugins-icon-container">
                                <label for="newpassword" class="form-label fs-5 fw-bold mb-3">{{ __('Nueva contraseña') }}</label>
                        ...
                        <div class="col-lg-4">
                            <div class="fv-row mb-0 fv-plugins-icon-container">
                                <label for="confirmpassword" class="form-label fs-5 fw-bold mb-3">{{ __('Confirmar nueva contraseña') }}</label>
                    ...
                    <div class="form-text mb-5">{{ __('La contraseña debe tener al menos 8 caracteres y contener símbolos.') }}
                    </div>

                    <div class="d-flex">
                        <button id="kt_password_submit" type="button" class="btn btn-primary me-2 px-6">{{ __('Actualizar contraseña') }}</button>
            ...
            <div id="kt_signin_password_button" class="ms-auto">
                <button class="btn btn-primary">{{ __('Cambiar contraseña') }}</button>
            </div>
            <!--end::Action-->
        </div>
        <!--end::Password-->
            ...
            <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                ...
                <div class="mb-3 mb-md-0 fw-semibold">
                    ...
                    @if (!$usuario->google2fa_secret)
                        <div class="fs-6 text-gray-700 pe-7">{{ __('La autenticación de dos factores agrega una capa adicional de seguridad a su cuenta. Para primary sesión, además deberás proporcionar un código de 6 dígitos') }}</div>
                    @else
                        <div class="fs-6 text-gray-700 pe-7">{{ __('¿Quieres inhabilitar la autenticación de dos factores? Presiona el botón de') }} <strong>{{ __('CANCELAR') }}</strong></div>
                    @endif
                </div>
                <!--end::Content-->
        ...
        <div class="security-section mt-5">
            ...
            <button class="btn btn-outline btn-outline-danger mt-3" id="closeAllSessions">
                <i class="bi bi-box-arrow-right me-2"></i>{{ __('Cerrar todas las sesiones') }}
            </button>
        </div>
    </div>
    <!--end::Card body-->
