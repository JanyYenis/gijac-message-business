    ...
    <section id="modulos" class="section modules-section">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="section-lead reveal" data-reveal="up">{{ __('Descubre todas las herramientas que necesitas para gestionar tu comunicación empresarial de manera eficiente.') }}</p>
            </div>
                    ...
                    <div class="benefit-list">
                        <div class="benefit-item reveal" data-reveal="right">
                            ...
                            <div>
                                ...
                                <p>{{ __('Integración directa con la API oficial de WhatsApp Business para máxima confiabilidad y entrega garantizada.') }}</p>
                            </div>
                        </div>
                        <div class="benefit-item reveal" data-reveal="right">
                            <div class="benefit-icon">
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 order-lg-2">
                    ...
                    <h2 class="section-title text-start reveal" data-reveal="up">
                        {{ __('Potencia tu negocio con') }} <span class="gradient-text">{{ __('Inteligencia Artificial') }}</span>
                    </h2>
    ...
    <section id="app" class="section app-section">
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-6">
                    <span class="badge-pill reveal" data-reveal="up">
                        <span class="dot-live"></span> {{ __('App móvil') }} · {{ __('iOS') }} &amp; {{ __('Android') }}
                    </span>
                    <h2 class="app-title">
