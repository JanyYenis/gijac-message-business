        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h1 class="modal-title text-white" id="cargarContactosModalLabel">
                    <i class="fas fa-upload fs-2"></i>{{ __('Cargar Contactos') }}</h1>
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-info-custom alert-dismissible fade show" role="alert" id="infoAlert">
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            <strong>{{ __('Información importante:') }}</strong>{{ __('Por favor, no cambie el orden de los campos que va
                            a cargar.
                            Si desea tener un ejemplo de la estructura de los archivos, puede descargarlos dando clic en
                            el botón de Excel que aparece a continuación.') }</div>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                        aria-label="{{ __('Cerrar alerta') }}"></button>
                </div>
                ...
                <div class="mb-4">
                    <a type="button" href="{{ asset('estructuras/contactos.xlsx') }}" class="btn btn-excel"
                        id="downloadTemplate">
                        <i class="fas fa-file-excel excel-icon"></i>{{ __('Excel') }}</a>
                </div>
                ...
                <div class="checkbox-container">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="removeHeader">
                            <i class="fas fa-header me-2"></i>{{ __('Eliminar encabezado') }}</label>
                    </div>
                </div>
                ...
                <form id="kt_dropzonejs_example_1" enctype="multipart/form-data" class="dropzone">
                    <div class="fv-row">
                        <div class="dz-message needsclick">
                            ...
                            <div class="ms-4">
                                <h3 class="fs-3x fw-bold text-gijac mb-1">{{ __('Cargar Archivo Excel') }}</h3>
                                <span class="fs-3 fw-semibold text-gray-400">{{ __('Maximo 1 Archivos') }}</span>
                            </div>
                        </div><br>
                    </div>
                </form>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="enviarButton">
                    <i class="fas fa-upload me-2"></i>{{ __('Cargar') }}</button>
            </div>
        </div>
    </div>
</div>
