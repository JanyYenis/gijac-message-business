        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <label for="nombre" class="form-label fs-4">
                    <i class="bi bi-person text-dark fs-4 me-1"></i>{{ __('Nombre') }}
                </label>
            ...
            <div class="col-md-6">
                <label for="apellido" class="form-label fs-4">
                    <i class="bi bi-person text-dark fs-4 me-1"></i>{{ __('Apellido') }}
                </label>
            ...
            <div class="col-md-6">
                <label for="genero" class="form-label fs-4">
                    <i class="bi bi-gender-ambiguous text-dark fs-4 me-1"></i>{{ __('Genero') }}
                </label>
                <select class="form-select" id="genero" data-control="select2"
                    ...
                    @foreach ($generos as $item)
                        <option value="{{ $item?->codigo }}"
                            {{ $item?->codigo == $usuario?->genero ? 'selected' : '' }}>{{ __($item?->nombre) ?? 'N/A' }}
                        </option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="col-md-6">
                <label for="tipoId" class="form-label fs-4">
                    <i class="bi bi-card-text text-dark fs-4 me-1"></i>{{ __('Tipo de Identificacion') }}
                </label>
            ...
            <div class="col-md-6">
                <label for="identificacion" class="form-label fs-4">
                    <i class="bi bi-hash text-dark fs-4 me-1"></i>{{ __('Numero de Identificacion') }}
                </label>
                <input type="text" class="form-control" id="identificacion" name="identificacion" required
                    placeholder="{{ __('Ingresa tu identificación') }}" value="{{ $usuario?->identificacion ?? '' }}">
            </div>
