                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="mb-5">
                        <h2 class="h3 mb-3" style="color: var(--primary-color);">
                            <i class="fas fa-shield-alt me-2"></i>{{ __('Introducción') }}
                        </h2>
                        <p class="mb-3">
                            {{ __('En GIJAC MESSAGE BUSINESS, nos comprometemos a proteger y respetar su privacidad. Esta política de privacidad explica cómo recopilamos, utilizamos, almacenamos y protegemos su información personal cuando utiliza nuestros servicios.') }}
                        </p>
                        <p>
                            {{ __('Al utilizar nuestra plataforma, usted acepta las prácticas descritas en esta política de privacidad. Le recomendamos que lea cuidadosamente este documento antes de utilizar nuestros servicios.') }}
                        </p>
                    </div>
                    ...
                    <div class="mb-5">
                        <h2 class="h3 mb-3" style="color: var(--primary-color);">
                            <i class="fas fa-database me-2"></i>{{ __('Datos que Recopilamos') }}
                        </h2>
                    ...
                    <div class="mb-5">
                        <h2 class="h3 mb-3" style="color: var(--primary-color);">
                            <i class="fas fa-cogs me-2"></i>{{ __('Uso de los Datos') }}
                        </h2>
                    ...
                    <div class="mb-5">
                        <h2 class="h3 mb-3" style="color: var(--primary-color);">
                            <i class="fas fa-lock me-2"></i>{{ __('Protección de la Información') }}
                        </h2>
                        <p class="mb-3">
                            {{ __('Implementamos medidas técnicas y organizativas apropiadas para proteger su información personal contra el acceso no autorizado, alteración, divulgación o destrucción.') }}
                        </p>
                    ...
                    <div class="mb-5">
                        <h2 class="h3 mb-3" style="color: var(--primary-color);">
                            <i class="fas fa-user-shield me-2"></i>{{ __('Derechos del Usuario') }}
                        </h2>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <i class="fas fa-eye text-primary me-2"></i>{{ __('Acceso') }}
                                        </h5>
                            ...
                            <div class="col-md-6">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <i class="fas fa-edit text-primary me-2"></i>{{ __('Rectificación') }}
                                        </h5>
                            ...
                            <div class="col-md-6">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <i class="fas fa-trash text-primary me-2"></i>{{ __('Eliminación') }}
                                        </h5>
                            ...
                            <div class="col-md-6">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <i class="fas fa-ban text-primary me-2"></i>{{ __('Limitación') }}
                                        </h5>
                            ...
                            <div class="col-md-6">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <i class="fas fa-download text-primary me-2"></i>{{ __('Portabilidad') }}
                                        </h5>
                            ...
                            <div class="col-md-6">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <i class="fas fa-times-circle text-primary me-2"></i>{{ __('Oposición') }}
                                        </h5>
                    ...
                    <div class="mb-5">
                        ...
                        <p class="mb-3">
                            {{ __('Si tiene preguntas, comentarios o inquietudes sobre esta política de privacidad o sobre cómo manejamos su información personal, no dude en contactarnos:') }}
                        </p>
                                    ...
                                    <div class="col-md-6 d-none">
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="mb-2">
                                                ...
                                                <strong>{{ __('DPO:') }}</strong> {{ __('María González') }}
                                            </li>
                                            <li class="mb-2">
                                                <i class="fas fa-envelope me-2 text-primary"></i>
                        ...
                        <div class="alert alert-warning mt-3">
                            ...
                            <strong>{{ __('Tiempo de Respuesta:') }}</strong> {{ __('Nos comprometemos a responder a todas las consultas relacionadas con la privacidad dentro de 30 días hábiles.') }}
                        </div>
                    </div>
                    ...
                    <div class="mb-5">
                        <div class="card" style="border-left: 5px solid var(--primary-color);">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <i class="fas fa-sync-alt me-2"></i>{{ __('Cambios en esta Política') }}
                                </h5>
                                <p class="card-text mb-3">
                                    {{ __('Podemos actualizar esta política de privacidad de vez en cuando para reflejar cambios en nuestras prácticas de información o en la legislación aplicable.') }}
                                </p>
                                <ul class="mb-0">
