            ...
            <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                ...
                <form id="kt_signin_change_email" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                    ...
                    <div class="d-flex">
                        ...
                        <button id="kt_signin_cancel" type="button" class="btn btn-cancelar btn-active-light-primary px-6">Cancelar</button>
                    </div>
                </form>
                <!--end::Form-->
            </div>
            ...
            <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                ...
                <div class="mb-3 mb-md-0 fw-semibold">
                    ...
                    @if (!$usuario->google2fa_secret)
                        <div class="fs-6 text-gray-700 pe-7">La autenticación de dos factores agrega una capa adicional de seguridad a su cuenta. Para primary sesión, además deberás proporcionar un código de 6 dígitos</div>
                    @else
                ...
                <!--begin::Action-->
                @if (!$usuario->google2fa_secret)
                    <a href="javascript:;" class="btn btn-primary px-6 align-self-center text-nowrap" data-bs-toggle="modal" data-bs-target="#kt_modal_two_factor_authentication">
                        Permitir
                    </a>
                @else
                    <a href="javascript:;" class="btn btn-primary px-6 align-self-center text-nowrap btnCancelarDosFactores">
                        Cancelar
                    </a>
                @endif
                <!--end::Action-->
