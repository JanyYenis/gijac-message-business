        ...
        <div class="modal-content" style="border: none; border-radius: 12px; overflow: hidden;">
            ...
            <div class="modal-header-wizard">
                <h5 id="modalTitle" class="text-white">
                    <i class="fas fa-chart-line"></i> {{ __('Análisis Predictivo de Campañas') }}
                </h5>
            </div>
            ...
            <div class="modal-body-wizard">
                ...
                <div class="wizard-step active" id="step-1">
                    <div class="step-title">
                        <i class="bi bi-card-text text-dark"></i> {{ __('Selecciona una Plantilla') }}
                    </div>
                    <div class="step-description">
                        {{ __('Elige la plantilla de campaña que deseas analizar para predecir la tasa de apertura.') }}
                    </div>
                ...
                <div class="wizard-step" id="step-2">
                    <div class="step-title">
                        <i class="bi bi-people-fill text-dark"></i> {{ __('Selecciona Usuarios') }}
                    </div>
                    <div class="step-description">
                        {{ __('Elige los usuarios a los que deseas analizar la predicción de apertura.') }}
                    </div>
                    <div class="selected-info" id="selectedTemplateInfo" style="display: none;">
                        {{ __('Plantilla seleccionada:') }} <strong id="selectedTemplateName"></strong>
                    </div>
            ...
            <div class="modal-footer-wizard">
                <button type="button" class="btn-custom btn-secondary-wizard" id="btnAnterior" style="display: none;">
                    <i class="bi bi-chevron-left text-dark"></i> {{ __('Anterior') }}
                </button>
                ...
                <button type="button" class="btn-custom btn-primary-wizard" id="btnSiguiente" disabled>
                    {{ __('Siguiente') }} <i class="bi bi-chevron-right text-white"></i>
                </button>
            </div>
        </div>
    </div>
