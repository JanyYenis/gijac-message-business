...
@section('content')
    <div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
        ...
        <div style="padding-bottom: 30px">
            {{ __('Está recibiendo este correo electrónico porque recibimos una solicitud de restablecimiento de contraseña para su cuenta. Para continuar con el restablecimiento de contraseña, haga clic en el botón a continuación:') }}
        </div>
        ...
        <div style="padding-bottom: 30px">
            {{ __('Este enlace para restablecer la contraseña caducará en 60 minutos. Si no solicitó un restablecimiento de contraseña, no es necesario realizar ninguna otra acción.') }}
        </div>
